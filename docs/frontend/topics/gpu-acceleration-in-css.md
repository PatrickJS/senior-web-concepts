...
GPU acceleration usually means moving compositable work such as transforms and opacity to compositor layers. It can improve animation smoothness but too many layers waste memory and can hurt performance.
